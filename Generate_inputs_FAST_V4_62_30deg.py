...
if Move_Out == 'False' and Calculate_bts == 'False' and Calculate_IEC == 'False' and Calculate_all_windfiles == 'False' and Calc_Rest_FAST == 'False' and Calc_Rest_TurbSim == 'False':
    ...
    directions_names_63=np.array(['-50deg','-10deg','+00deg','+10deg','+50deg'])
    directions_63=np.array(['-50','-10','0','10','50'])
    ...
    for i in range(file_number):
        ...
        if actual_DLC == '61' or actual_DLC == '62' or actual_DLC == '63' or actual_DLC == '64' or actual_DLC == '71':
            ...
            data[46]='          0   HSSBrMode    - HSS brake model {0: none, 1: simple, 3: user-defined from routine UserHSSBr, 4: user-defined from Simulink/Labview, 5: user-defined from Bladed-style DLL} (switch)\n'
            data[47]='     9999.9   THSSBrDp     - Time to initiate deployment of the HSS brake (s)\n'
...
if Calc_Rest_FAST == 'True':
    for i in range(len(file_list_raw)):
        if not os.path.exists(root_FAST+file_list_raw[i]+".out"):
            z_exist = z_exist + 1
