...
if Move_Out == 'False' and Calculate_bts == 'False' and Calculate_IEC == 'False' and Calculate_all_windfiles == 'False' and Calc_Rest_FAST == 'False' and Calc_Rest_TurbSim == 'False':
    ...
    new_data=[""]*(168 + n_MExtremes_files + Extreme_DLCs)
    new_data[0:167]=data[0:167]
    
    # constant entries
    new_data[168 + n_MExtremes_files + Extreme_DLCs -1]="==EOF==                             DO NOT REMOVE OR CHANGE.  MUST COME JUST AFTER LAST LINE OF VALID INPUT.\n"
