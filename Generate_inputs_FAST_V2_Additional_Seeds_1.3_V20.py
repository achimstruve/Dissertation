...
if Move_Out == 'False' and Calculate_bts == 'False' and Calculate_IEC == 'False' and Calculate_all_windfiles == 'False' and Test_Out == 'False':
    ...
    seed_names_11=np.array(['S1','S2','S3','S4','S5','S6','S7','S8','S9','S10','S11','S12','S13','S14','S15','S16','S17','S18','S19','S20','S21','S22','S23','S24','S25','S26','S27','S28','S29','S30'])
    ...
    n13seeds = 500
    seed_names = []
    for sn in range(n13seeds):
        seed_names.append('S'+str(sn+1))
    #seed_names=np.array(['S1','S2','S3','S4','S5','S6','S7','S8','S9','S10','S11','S12','S13','S14','S15','S16','S17','S18','S19','S20','S21','S22','S23','S24','S25','S26','S27','S28','S29','S30'])

    # filesets for DLC 1.3, DLC 1.5
    wind_speeds_names=np.array(['V20'])
    wind_speeds=np.array(['20.0'])
    ...
    # initialize new file data
    Extreme_DLCs = 14
    n_MExtremes_files = file_number_11 + file_number_13 + file_number_14 + file_number_15
    new_data=[""]*(167 + n_MExtremes_files + Extreme_DLCs)
    new_data[0:166]=data[0:166]
    
    # constant entries
    new_data[167 + n_MExtremes_files + Extreme_DLCs -1]="==EOF==                             DO NOT REMOVE OR CHANGE.  MUST COME JUST AFTER LAST LINE OF VALID INPUT.\n"
