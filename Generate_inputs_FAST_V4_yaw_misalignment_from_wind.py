...
if Move_Out == 'False' and Calculate_bts == 'False' and Calculate_IEC == 'False' and Calculate_all_windfiles == 'False' and Calc_Rest_FAST == 'False' and Calc_Rest_TurbSim == 'False':
    ...
    directions_names=np.array(['-08deg','+00deg','+08deg'])
    directions=np.array(['-8','0','8'])
    ...
    file_number_23 = len(wind_speeds_names_2345)*len(delta_EOG)
    file_number_31 = len(wind_speeds_names_31_41)
    file_number_32 = len(wind_speeds_names_2345) * len(delta_EOG)
    file_number_33 = len(wind_speeds_names_2345) * len(delta_EDC) * len(signs)
    file_number_41 = len(wind_speeds_names_31_41)
    file_number_42 = len(wind_speeds_names_2345) * len(delta_EOG)
    file_number_51 = len(seed_names) * len(wind_speeds_names_2345) * len(directions)
    file_number_61 = len(seed_names) * len(directions_61)
    file_number_62 = len(seed_names) * len(directions_62)
    file_number_63 = len(seed_names) * len(directions_63)
    file_number_64 = len(wind_speeds_names_64) * len(directions_64) *len(seed_names)
    file_number_71 = len(seed_names) * len(directions_71)
    ...
    file_number_TurbSim = int(file_number_11 + file_number_13 + file_number_21 + file_number_51 + file_number_61 + file_number_62 + file_number_63 + file_number_64 + file_number_71)
    TS_number_TurbSim = int(file_number_11/len(directions) + file_number_13/len(directions) + file_number_21/len(directions) + file_number_51/len(directions) + file_number_61/len(directions_61) + file_number_62/len(directions_62) + file_number_63/len(directions_63) + file_number_64/len(directions_64) + file_number_71/len(directions_71))

    file_number=file_number_TurbSim+file_number_IECwind+file_number_steady
    
    file_list=np.zeros([file_number,3],dtype=list)
    file_list_TS=np.zeros(TS_number_TurbSim,dtype=list)
    file_list_raw=np.zeros(file_number,dtype=list)
    ...
    job_distr_TurbSim=int(np.ceil(TS_number_TurbSim/cores))
    job_distr_TurbSim_rest = job_distr_TurbSim - TS_number_TurbSim/cores
    job_distr_TurbSim_overflow = (TS_number_TurbSim/cores)%1
    ...
    for j in range(len(wind_speeds_names_11)):
        ...
        for i in range(len(seed_names_tmp)):
            for m in range(len(directions)):
                if (m == 0):
                    shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename11+"T_"+wind_speeds_names_11[j]+"_"+seed_names_tmp[i]+Input_ending)
                    print filename11+"T_"+wind_speeds_names_11[j]+"_"+seed_names_tmp[i]+" was generated."
                    filename11i=root_TurbSim+filename11+"T_"+wind_speeds_names_11[j]+"_"+seed_names_tmp[i]+Input_ending
                    ...
                    with open(filename11i, 'w') as file:
                        ...
                        file.close
                    file_list_TS[zTS] = filename11+"T_"+wind_speeds_names_11[j]+"_"+seed_names_tmp[i]
                    zTS += 1
                file_list[z,0]=filename11+"T_"+directions_names[m]+"_"+wind_speeds_names_11[j]+"_"+seed_names_tmp[i]+Input_ending
                file_list[z,1] = directions[m]
                file_list[z,2] = zTS-1
    ...
    for j in range(len(wind_speeds_names)):
        ...
        for i in range(len(seed_names_tmp)):    
            for m in range(len(directions)):
                if (m == 0):
                    shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename13+"T_"+wind_speeds_names[j]+"_"+seed_namesl[i]+Input_ending)
                    print filename13+"T_"+wind_speeds_names[j]+"_"+seed_namesl[i]+" was generated."
                    filename13i=root_TurbSim+filename13+"T_"+wind_speeds_names[j]+"_"+seed_namesl[i]+Input_ending
                    ...
                    with open(filename13i, 'w') as file:
                        file.writelines( data )
                        file.close
                    file_list_TS[zTS] = filename13+"T_"+wind_speeds_names[j]+"_"+seed_namesl[i]
                    zTS += 1
                file_list[z,0]=filename13+"T_"+directions_names[m]+"_"+wind_speeds_names[j]+"_"+seed_namesl[i]+Input_ending
                file_list[z,1] = directions[m]
                file_list[z,2] = zTS-1
    ...
    for j in range(len(wind_speeds_names_14)):
        for k in range(len(signs)):
            for m in range(len(directions)):
                ...
                name_IEC[z_IEC] = filename14+"_"+directions_names[m]+"_"+signs[k]+"_"+wind_speeds_names_14[j]
                file_list[z,0]=filename14+"_"+directions_names[m]+"_"+signs[k]+"_"+wind_speeds_names_14[j]+IEC_ending
                file_list[z,1] = directions[m]
                file_list_raw[z]=filename14+"_"+directions_names[m]+"_"+signs[k]+"_"+wind_speeds_names_14[j]
                print filename14+"_"+directions_names[m]+"_"+signs[k]+"_"+wind_speeds_names_14[j]+" was generated."
                z=z+1
                z_IEC = z_IEC + 1
        ...
        for j in range(len(DLC15_spec)):
            for k in range(len(signs)):
                for m in range(len(directions)):
                    ...
                    file_list[z,0] = filename15+"_"+directions_names[m]+"_"+DLC15_spec[j]+"_"+signs[k]+"_"+wind_speeds_names[i]+IEC_ending
                    file_list[z,1] = directions[m]
    ...
    for i in range(len(seed_names_21)):
        for j in range(len(wind_speeds_names_21)):
            for m in range(len(directions)):
                if (m == 0):
                    shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename21+"T_"+wind_speeds_names_21[j]+"_"+seed_names_21[i]+Input_ending)
                    print filename21+"T_"+wind_speeds_names_21[j]+"_"+seed_names_21[i]+" was generated."
                    filename21i=root_TurbSim+filename21+"T_"+wind_speeds_names_21[j]+"_"+seed_names_21[i]+Input_ending
                    ...
                    with open(filename21i, 'w') as file:
                        file.writelines( data )
                        file.close
                    file_list_TS[zTS] = filename21+"T_"+wind_speeds_names_21[j]+"_"+seed_names_21[i]
                    zTS += 1
                file_list[z,0]=filename21+"T_"+directions_names[m]+"_"+wind_speeds_names_21[j]+"_"+seed_names_21[i]+Input_ending
                file_list[z,1] = directions[m]
                file_list[z,2] = zTS-1
    ...
    for i in range(len(delta_EOG)):
        for j in range(len(wind_speeds_names_2345)):
            ...
            file_list[z,0]=filename23+"_"+delta_EOG_names[i]+"_"+wind_speeds_names_2345[j]+IEC_ending
    ...
    for i in range(len(wind_speeds_names_31_41)):
        file_list[z,0]=filename31+"_"+wind_speeds_names_31_41[i]
    ...
    for i in range(len(delta_EOG)):
        for j in range(len(wind_speeds_names_2345)):
            ...
            file_list[z,0]=filename32+"_"+delta_EOG_names[i]+"_"+wind_speeds_names_2345[j]+IEC_ending
    ...
    for i in range(len(delta_EDC)):
        for j in range(len(wind_speeds_names_2345)):
            for k in range(len(signs)):
                ...
                file_list[z,0]=filename33+"_"+delta_EDC_names[i]+"_"+signs[k]+"_"+wind_speeds_names_2345[j]+IEC_ending
    ...
    # DLC 4.1
    for i in range(len(wind_speeds_names_31_41)):
        file_list[z,0]=filename41+"_"+wind_speeds_names_31_41[i]
    ...
    for i in range(len(delta_EOG)):
        for j in range(len(wind_speeds_names_2345)):
            ...
            file_list[z,0]=filename42+"_"+delta_EOG_names[i]+"_"+wind_speeds_names_2345[j]+IEC_ending
    ...
    for i in range(len(wind_speeds_names_2345)):
        for j in range(len(seed_names)):
            for k in range(len(directions_names)):
                if (k == 0):
                    shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename51+"T_"+wind_speeds_names_2345[i]+"_"+seed_names[j]+Input_ending)
                    print filename51+"T_"+wind_speeds_names_2345[i]+"_"+seed_names[j]+" was generated."
                    filename51i=root_TurbSim+filename51+"T_"+wind_speeds_names_2345[i]+"_"+seed_names[j]+Input_ending
                    ...
                    with open(filename51i, 'w') as file:
                        file.writelines( data )
                        file.close
                    file_list_TS[zTS] = filename51+"T_"+wind_speeds_names_2345[i]+"_"+seed_names[j]
                    zTS += 1
                file_list[z,0]=filename51+"T_"+directions_names[k]+"_"+wind_speeds_names_2345[i]+"_"+seed_names[j]+Input_ending
                file_list[z,1] = directions[k]
                file_list[z,2] = zTS-1
    ...
    for i in range(len(seed_names)):
        for m in range(len(directions_61)):
            if (m == 0):
                shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename61+"T_"+seed_names[i]+Input_ending)
                print filename61+"T_"+seed_names[i]+" was generated."
                filename61i=root_TurbSim+filename61+"T_"+seed_names[i]+Input_ending
                ...
                with open(filename61i, 'w') as file:
                    file.writelines( data )
                    file.close
                file_list_TS[zTS] = filename61+"T_"+seed_names[i]
                zTS += 1
            file_list[z,0]=filename61+"T_"+directions_names_61[m]+"_"+seed_names[i]+Input_ending
            file_list[z,1] = directions_61[m]
            file_list[z,2] = zTS-1
    ...
    for i in range(len(seed_names)):
        for m in range(len(directions_62)):
            if (m == 0):
                shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename62+"T_"+seed_names[i]+Input_ending)
                print filename62+"T_"+seed_names[i]+" was generated."
                filename62i=root_TurbSim+filename62+"T_"+seed_names[i]+Input_ending
                ...
                with open(filename62i, 'w') as file:
                    file.writelines( data )
                    file.close
                file_list_TS[zTS] = filename62+"T_"+seed_names[i]
                zTS += 1
            file_list[z,0]=filename62+"T_"+directions_names_62[m]+"_"+seed_names[i]+Input_ending
            file_list[z,1] = directions_62[m]
            file_list[z,2] = zTS-1
    ...
    for i in range(len(seed_names)):
        for m in range(len(directions_63)):
            if (m == 0):
                shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename63+"T_"+seed_names[i]+Input_ending)
                print filename63+"T_"+seed_names[i]+" was generated."
                filename63i=root_TurbSim+filename63+"T_"+seed_names[i]+Input_ending
                ...
                with open(filename63i, 'w') as file:
                    file.writelines( data )
                    file.close
                file_list_TS[zTS] = filename63+"T_"+seed_names[i]
                zTS += 1
            file_list[z,0]=filename63+"T_"+directions_names_63[m]+"_"+seed_names[i]+Input_ending
            file_list[z,1] = directions_63[m]
            file_list[z,2] = zTS-1
    ...
    for i in range(len(wind_speeds_names_64)):
        for j in range(len(seed_names)):
            for k in range(len(directions_names_64)):
                if (k == 0):
                    shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename64+"T_"+wind_speeds_names_64[i]+"_"+seed_names[j]+Input_ending)
                    print filename64+"T_"+wind_speeds_names_64[i]+"_"+seed_names[j]+" was generated."
                    filename64i=root_TurbSim+filename64+"T_"+wind_speeds_names_64[i]+"_"+seed_names[j]+Input_ending
                    ...
                    with open(filename64i, 'w') as file:
                        file.writelines( data )
                        file.close
                    file_list_TS[zTS] = filename64+"T_"+wind_speeds_names_64[i]+"_"+seed_names[j]
                    zTS += 1
                file_list[z,0]=filename64+"T_"+directions_names_64[k]+"_"+wind_speeds_names_64[i]+"_"+seed_names[j]+Input_ending
                file_list[z,1] = directions_64[k]
                file_list[z,2] = zTS-1
    ...
    for i in range(len(seed_names)):
        for m in range(len(directions_71)):
            if (m == 0):
                shutil.copyfile(root_TurbSim+TurbSim_Input+Input_ending, root_TurbSim+filename71+"T_"+seed_names[i]+Input_ending)
                print filename71+"T_"+seed_names[i]+" was generated."
                filename71i=root_TurbSim+filename71+"T_"+seed_names[i]+Input_ending
                ...
                with open(filename71i, 'w') as file:
                    file.writelines( data )
                    file.close
                file_list_TS[zTS] = filename71+"T_"+seed_names[i]
                zTS += 1
            file_list[z,0]=filename71+"T_"+directions_names_71[m]+"_"+seed_names[i]+Input_ending
            file_list[z,1] = directions_71[m]
            file_list[z,2] = zTS-1
    ...
    for i in range(cores):
        ...
        for k in range(z2,len(file_list_TS)):        
            actual_DLC_tmp = file_list_TS[k]
            ...
            if job_distr_TurbSim_current > 0:
                if actual_DLC_type == 'T':
                    string="TurbSim_x64 "+file_list_TS[k]+".inp\n"
    ...
    for i in range(file_number):
        ...
        if actual_DLC_tmp[6] == 'T':
            data[19]='"Wind/'+file_list_TS[int(file_list[i,2])]+'.bts"    Filename       - Name of the Full field wind file to use (.bts)\n'
    ...
    for i in range(file_number):
        ...
        # set nacell yaw position for all DLCs
        data[53]='       '+str(file_list[i,1])+'   YawNeut      - Neutral yaw position--yaw spring force is zero at this yaw (degrees)\n'
        # for DLC 14 and different wind directions
        #if actual_DLC == '14':
