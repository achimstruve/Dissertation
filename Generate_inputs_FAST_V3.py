...
if Move_Out == 'False' and Calculate_bts == 'False' and Calculate_IEC == 'False' and Calculate_all_windfiles == 'False' and Test_Out == 'False':
    ...
    file_number_11=len(seed_names_11)*len(wind_speeds_names_11)*len(directions) + nseeds_long-6
    file_number_13=len(seed_names)*len(wind_speeds_names)*len(directions) + (nseeds_long-6)*2
    ...
    for j in range(len(wind_speeds_names_11)):
        ...
        if j == len(wind_speeds_names_11)-1: 
            seed_names_tmp = seed_namesl
    ...
    for j in range(len(wind_speeds_names)):
        ...
        if (j == len(wind_speeds_names)-1) or (j == len(wind_speeds_names)-3): 
            seed_names_tmp = seed_namesl
        for i in range(len(seed_names_tmp)):    
            for m in range(len(directions)):
